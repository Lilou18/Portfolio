...
export class Collectible {
    ...
    constructor(k, x, y) {
        ...
        this.gameObject = world.add([
            ...
            k.area({ isSensor: true, collisionIgnore:["collectible", "collider", "borderLeft", "borderRight", "enemy", "hologramPortfolio", "hologramCV", "hologramContact", "citySign" ], }),                                           // Enables collision detection
            k.anchor("center"),
